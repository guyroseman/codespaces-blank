...
public class tester2
{
    ...
    public static void main (String[] args)
    {
        ...
        //Test toString()            
        System.out.println("\nTesting toString after adding 4 more Rent(five rents are Rent duplacte!) \norder of rents is important - early pickDate should be first\nafter that bigger duration first:");
        ...
        System.out.println("NULL TEST:   "+nullC.getNumOfRents());
        ...
        System.out.println("NULL TEST:  "+nullC.getSumOfPrices());
        ...
        System.out.println("NULL TEST: "+nullC.lastCarRent());
        ...
        System.out.println("NULL TEST: "+nullC.longestRent());
        ...
        System.out.println("NULL TEST: "+nullC.mostCommonRate());
        ...
        System.out.println("\nTesting second time removeRent(Date d):");
        success = comp1.removeRent(new Date(9,7,2018));  
        if(success == false)  
            System.out.println("looks good");
        else
            System.out.println("no good");
        System.out.println("\nTesting third time removeRent(Date d):");
        success = comp1.removeRent(new Date(9,7,2018));  
        if(success == false)  
            System.out.println("looks good");
        else
        ...
        System.out.println("Testing includes with company that is included in another one should return false while student code returns: " + comp2.includes(comp1)); 
        System.out.println("Testing includes with company that is included in the same one should return true while student code returns: " + comp1.includes(comp1)); 
        System.out.println("Testing includes with company that is included in null one should return false while student code returns: " + nullC.includes(comp1)); 
        System.out.println("Testing includes with null company that is included in another one should return true while student code returns: " + comp1.includes(nullC)); 
